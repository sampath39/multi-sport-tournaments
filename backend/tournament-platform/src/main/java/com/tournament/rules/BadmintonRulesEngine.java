...
@Component
public class BadmintonRulesEngine extends AbstractSportRulesEngine {

    @Override
    public SportCode getSportCode() {
        return SportCode.BADMINTON;
    }
    ...
    public boolean isDrawAllowed(TournamentFormat format) {
        return false; // BWF Badminton matches are best-of-3 games, draws not permitted
    }
